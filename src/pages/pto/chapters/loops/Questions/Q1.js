  ...
  return (
    <div className="pt-20">
      ...
      <div className=" flex flex-col text-2xl text-yellow-500 m-10 items-center">
        ...
        <div className="text-left bg-black-950 p-5 rounded-lg text-white">
          <p>{"int i, j;"}</p>
          <p>{"for(i=0; i<3; i++);"}</p>
          <p>{"{"}</p>
          <p>{"for(j=0; j<3; j++);"}</p>
      ...
      <div className=" flex flex-col  text-2xl text-yellow-500 m-10">
        ...
        <div className="flex flex-row flex-wrap justify-evenly items-baseline">
          <div
            className="text-left bg-black-950 p-5 rounded-lg text-white scale-90 hover:scale-100 transition-all ease-in-out duration-300 hover:cursor-pointer"
            onClick={correct}
          >
            <p>{"0"}</p>
            <p>{"1"}</p>
          ...
          <div className="text-left bg-black-950 p-5 rounded-lg text-white scale-90 hover:scale-100 transition-all ease-in-out duration-300 hover:cursor-pointer">
            <p>{"0"}</p>
            <p>{"1"}</p>
            <p>{"Best of Luck"}</p>
          </div>
